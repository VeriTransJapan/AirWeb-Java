...
<body>
    ...
    <div class="contents">
        ...
        <html:errors />
        <br />
        <html:form action="/if_cardConfirmaction" onsubmit="document.getElementById('submitBtn').disabled=true;">
            ...
            <table class="settlement">
                ...
                <tr>
                    ...
                    <td class="pal">Credit Card</td>
                <tr>
                <tr>
                    <td class="type">Number of payment</td>
                    <td class="pal">
                        <html:select property="cardInstallmentJpo" size="1">
                            <html:option value="">Not specified</html:option>
                            <html:option value="10">Lump-sum</html:option>
                            <html:option value="80">Revolving</html:option>
                        </html:select>
                    </td>
                </tr>
            </table>
